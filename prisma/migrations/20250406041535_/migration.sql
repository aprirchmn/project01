...
CREATE TABLE "hasil_ujian" (
    ...
    "nilai_total" DOUBLE PRECISION NOT NULL DEFAULT 0,
...
CREATE TABLE "mata_pelajaran_siswa" (
    ...
    CONSTRAINT "mata_pelajaran_siswa_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "mata_pelajaran_kode_mata_pelajaran_key" ON "mata_pelajaran"("kode_mata_pelajaran");
...
-- CreateIndex
CREATE UNIQUE INDEX "mata_pelajaran_siswa_id_mata_pelajaran_id_siswa_key" ON "mata_pelajaran_siswa"("id_mata_pelajaran", "id_siswa");
...
-- AddForeignKey
ALTER TABLE "mata_pelajaran_siswa" ADD CONSTRAINT "mata_pelajaran_siswa_id_mata_pelajaran_fkey" FOREIGN KEY ("id_mata_pelajaran") REFERENCES "mata_pelajaran"("id_mata_pelajaran") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "mata_pelajaran_siswa" ADD CONSTRAINT "mata_pelajaran_siswa_id_siswa_fkey" FOREIGN KEY ("id_siswa") REFERENCES "siswa"("id_siswa") ON DELETE RESTRICT ON UPDATE CASCADE;
